    ...
    <main className="mx-auto flex max-w-2xl px-5 py-16">
      <section className="w-full rounded-[1.75rem] border border-line bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 leading-7 text-muted">
          Stripe confirmed checkout. Resonate can now match this payment to the setup or monthly care step and follow up with the next customer action. Launch customers receive a private preview before the public page goes live.
        </p>
