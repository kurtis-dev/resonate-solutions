  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-16">
      ...
      <div className="mt-8 space-y-6 leading-7 text-muted">
        ...
        <p>Resonate Solutions provides local business presence services, including mobile pages, menu publishing, QR links, photo support, and related customer-facing materials.</p>
        ...
        <p>Add your legal or support contact email here before launch.</p>
      </div>
    </main>
  );
}
