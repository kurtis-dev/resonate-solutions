    ...
    <main className="mx-auto max-w-7xl px-5 py-16">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="mt-5 leading-7 text-muted">
          This is the first internal view for free menu review requests, Stripe subscription status, and payment events. Add authentication before sharing this URL publicly.
        </p>
      ...
      <div className="grid gap-6">
        <DataTable title="Recent free menu review requests" rows={intakes} columns={["created_at", "business_name", "contact_name", "email", "business_type", "city", "main_need", "package_interest"]} />
