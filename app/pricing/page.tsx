        ...
        <div className="mx-auto max-w-7xl px-5 py-16">
          <div className="max-w-4xl">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-muted">
              Resonate is built for small businesses that need a clean customer page, food menu, or services list without turning it into a full website project. Start with a fit check, pay once for setup, then choose whether you want monthly care after launch.
            </p>
          </div>
        </div>
      </section>
      <section className="mx-auto max-w-7xl px-5 py-14">
        ...
        <div className="mt-10 rounded-[1.75rem] border border-coral/25 bg-white p-7 shadow-sm">
          ...
          <p className="mt-4 max-w-3xl leading-7 text-muted">
            The free fit check helps clarify what the business needs. The one-time build fee starts the real page/menu/services work. Monthly care is separate and keeps the page current after launch.
          </p>
        </div>
      </section>
    </main>
